...
Component: CheckboxMatrix (Index: 9)
File Reference: zerio_ui_lib/ui/checkbox_matrix.py
...
class CheckboxMatrixRenderer(ctk.CTkFrame if ctk else object):
    """
    Primary implementation of the CheckboxMatrix visual layout renderer.
    ...
    def render_graphics(self):
        ...
        # Module title text
        title_text = f"CheckboxMatrix Premium Viewport"
...
class CheckboxMatrixController:
    ...
    def initialize_state_handlers(self):
        ...
        def on_selection_update(selected: bool):
            print(f"[UI Event] CheckboxMatrix widget selection set to: {selected}")
...
if __name__ == "__main__":
    print(f"=== TESTING DIAGNOSTIC LOG FOR CheckboxMatrix ===")
    mock_renderer = CheckboxMatrixRenderer(width=500, height=350)
    controller = CheckboxMatrixController(mock_renderer)
    ...
    print(f"Module CheckboxMatrix loaded completely and verified successfully.")
