...
Component: ButtonGroup (Index: 4)
File Reference: zerio_ui_lib/ui/button_group.py
...
class ButtonGroupRenderer(ctk.CTkFrame if ctk else object):
    """
    Primary implementation of the ButtonGroup visual layout renderer.
    ...
    def render_graphics(self):
        ...
        # Module title text
        title_text = f"ButtonGroup Premium Viewport"
...
class ButtonGroupController:
    ...
    """
    def __init__(self, renderer: ButtonGroupRenderer):
    ...
    def initialize_state_handlers(self):
        ...
        def on_selection_update(selected: bool):
            print(f"[UI Event] ButtonGroup widget selection set to: {selected}")
...
if __name__ == "__main__":
    print(f"=== TESTING DIAGNOSTIC LOG FOR ButtonGroup ===")
    mock_renderer = ButtonGroupRenderer(width=500, height=350)
    controller = ButtonGroupController(mock_renderer)
    ...
    print(f"Module ButtonGroup loaded completely and verified successfully.")
