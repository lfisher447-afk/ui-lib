...
Component: SplitPane (Index: 49)
File Reference: zerio_ui_lib/ui/split_pane.py
...
class SplitPaneRenderer(ctk.CTkFrame if ctk else object):
    """
    Primary implementation of the SplitPane visual layout renderer.
    ...
    def render_graphics(self):
        ...
        # Module title text
        title_text = f"SplitPane Premium Viewport"
...
class SplitPaneController:
    ...
    """
    def __init__(self, renderer: SplitPaneRenderer):
        self.renderer = renderer
        self.configuration_id = 49
    ...
    def initialize_state_handlers(self):
        ...
        def on_selection_update(selected: bool):
            print(f"[UI Event] SplitPane widget selection set to: {selected}")
...
if __name__ == "__main__":
    print(f"=== TESTING DIAGNOSTIC LOG FOR SplitPane ===")
    mock_renderer = SplitPaneRenderer(width=500, height=350)
    controller = SplitPaneController(mock_renderer)
    ...
    print(f"Module SplitPane loaded completely and verified successfully.")
