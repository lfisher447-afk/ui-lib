...
Blender SDK Addon Module: MocapDataRetargeter (Index: 35)
File Reference: zerio_ui_lib/addons/mocap_data_retargeter.py
...
class MocapDataRetargeterRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: MocapDataRetargeter ---")
    op = MocapDataRetargeterRiggingOperator()
