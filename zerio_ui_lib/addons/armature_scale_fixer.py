...
Blender SDK Addon Module: ArmatureScaleFixer (Index: 36)
File Reference: zerio_ui_lib/addons/armature_scale_fixer.py
...
class ArmatureScaleFixerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: ArmatureScaleFixer ---")
    op = ArmatureScaleFixerRiggingOperator()
