...
Blender SDK Addon Module: MirrorNamingSolver (Index: 8)
File Reference: zerio_ui_lib/addons/mirror_naming_solver.py
...
class MirrorNamingSolverRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: MirrorNamingSolver ---")
    op = MirrorNamingSolverRiggingOperator()
