...
Blender SDK Addon Module: LightRigGenerator (Index: 22)
File Reference: zerio_ui_lib/addons/light_rig_generator.py
...
class LightRigGeneratorRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: LightRigGenerator ---")
    op = LightRigGeneratorRiggingOperator()
