...
Blender SDK Addon Module: ArmatureHierarchyValidator (Index: 26)
File Reference: zerio_ui_lib/addons/armature_hierarchy_validator.py
...
class ArmatureHierarchyValidatorRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: ArmatureHierarchyValidator ---")
    op = ArmatureHierarchyValidatorRiggingOperator()
