...
Blender SDK Addon Module: AnimationKeyframesReducer (Index: 37)
File Reference: zerio_ui_lib/addons/animation_keyframes_reducer.py
...
class AnimationKeyframesReducerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: AnimationKeyframesReducer ---")
    op = AnimationKeyframesReducerRiggingOperator()
