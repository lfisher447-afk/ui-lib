...
Blender SDK Addon Module: BoneConstraintHandler (Index: 2)
File Reference: zerio_ui_lib/addons/bone_constraint_handler.py
...
class BoneConstraintHandlerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: BoneConstraintHandler ---")
    op = BoneConstraintHandlerRiggingOperator()
