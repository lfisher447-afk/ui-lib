...
Blender SDK Addon Module: UvUnwrapHelper (Index: 13)
File Reference: zerio_ui_lib/addons/uv_unwrap_helper.py
...
class UvUnwrapHelperRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: UvUnwrapHelper ---")
    op = UvUnwrapHelperRiggingOperator()
