...
Blender SDK Addon Module: MaterialsBatchAssigner (Index: 12)
File Reference: zerio_ui_lib/addons/materials_batch_assigner.py
...
class MaterialsBatchAssignerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: MaterialsBatchAssigner ---")
    op = MaterialsBatchAssignerRiggingOperator()
