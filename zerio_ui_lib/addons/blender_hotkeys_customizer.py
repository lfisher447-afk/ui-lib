...
Blender SDK Addon Module: BlenderHotkeysCustomizer (Index: 38)
File Reference: zerio_ui_lib/addons/blender_hotkeys_customizer.py
...
class BlenderHotkeysCustomizerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: BlenderHotkeysCustomizer ---")
    op = BlenderHotkeysCustomizerRiggingOperator()
