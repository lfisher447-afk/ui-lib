...
Blender SDK Addon Module: FbxExportPipeline (Index: 20)
File Reference: zerio_ui_lib/addons/fbx_export_pipeline.py
...
class FbxExportPipelineRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: FbxExportPipeline ---")
    op = FbxExportPipelineRiggingOperator()
