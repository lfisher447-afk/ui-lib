...
Blender SDK Addon Module: ShapekeyDriverMapper (Index: 9)
File Reference: zerio_ui_lib/addons/shapekey_driver_mapper.py
...
class ShapekeyDriverMapperRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: ShapekeyDriverMapper ---")
    op = ShapekeyDriverMapperRiggingOperator()
