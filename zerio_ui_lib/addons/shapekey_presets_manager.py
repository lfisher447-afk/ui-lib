...
Blender SDK Addon Module: ShapekeyPresetsManager (Index: 27)
File Reference: zerio_ui_lib/addons/shapekey_presets_manager.py
...
class ShapekeyPresetsManagerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: ShapekeyPresetsManager ---")
    op = ShapekeyPresetsManagerRiggingOperator()
