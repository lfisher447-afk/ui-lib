...
Blender SDK Addon Module: WeightPaintTransfer (Index: 3)
File Reference: zerio_ui_lib/addons/weight_paint_transfer.py
...
class WeightPaintTransferRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: WeightPaintTransfer ---")
    op = WeightPaintTransferRiggingOperator()
