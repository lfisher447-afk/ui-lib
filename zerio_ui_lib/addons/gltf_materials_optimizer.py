...
Blender SDK Addon Module: GltfMaterialsOptimizer (Index: 21)
File Reference: zerio_ui_lib/addons/gltf_materials_optimizer.py
...
class GltfMaterialsOptimizerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: GltfMaterialsOptimizer ---")
    op = GltfMaterialsOptimizerRiggingOperator()
