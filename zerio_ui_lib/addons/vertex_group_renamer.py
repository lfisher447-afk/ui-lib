...
Blender SDK Addon Module: VertexGroupRenamer (Index: 14)
File Reference: zerio_ui_lib/addons/vertex_group_renamer.py
...
class VertexGroupRenamerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: VertexGroupRenamer ---")
    op = VertexGroupRenamerRiggingOperator()
