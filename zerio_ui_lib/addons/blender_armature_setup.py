...
Blender SDK Addon Module: BlenderArmatureSetup (Index: 1)
File Reference: zerio_ui_lib/addons/blender_armature_setup.py
...
class BlenderArmatureSetupRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: BlenderArmatureSetup ---")
    op = BlenderArmatureSetupRiggingOperator()
