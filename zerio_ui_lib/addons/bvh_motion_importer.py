...
Blender SDK Addon Module: BvhMotionImporter (Index: 6)
File Reference: zerio_ui_lib/addons/bvh_motion_importer.py
...
class BvhMotionImporterRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: BvhMotionImporter ---")
    op = BvhMotionImporterRiggingOperator()
