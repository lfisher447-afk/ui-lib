...
Blender SDK Addon Module: PoseLibraryInterpolator (Index: 4)
File Reference: zerio_ui_lib/addons/pose_library_interpolator.py
...
class PoseLibraryInterpolatorRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: PoseLibraryInterpolator ---")
    op = PoseLibraryInterpolatorRiggingOperator()
