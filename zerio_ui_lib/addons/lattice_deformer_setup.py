...
Blender SDK Addon Module: LatticeDeformerSetup (Index: 28)
File Reference: zerio_ui_lib/addons/lattice_deformer_setup.py
...
class LatticeDeformerSetupRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: LatticeDeformerSetup ---")
    op = LatticeDeformerSetupRiggingOperator()
