...
Blender SDK Addon Module: DeformBonesExporter (Index: 15)
File Reference: zerio_ui_lib/addons/deform_bones_exporter.py
...
class DeformBonesExporterRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: DeformBonesExporter ---")
    op = DeformBonesExporterRiggingOperator()
