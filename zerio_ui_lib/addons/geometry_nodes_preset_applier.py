...
Blender SDK Addon Module: GeometryNodesPresetApplier (Index: 29)
File Reference: zerio_ui_lib/addons/geometry_nodes_preset_applier.py
...
class GeometryNodesPresetApplierRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: GeometryNodesPresetApplier ---")
    op = GeometryNodesPresetApplierRiggingOperator()
