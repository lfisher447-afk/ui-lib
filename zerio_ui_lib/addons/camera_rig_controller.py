...
Blender SDK Addon Module: CameraRigController (Index: 18)
File Reference: zerio_ui_lib/addons/camera_rig_controller.py
...
class CameraRigControllerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: CameraRigController ---")
    op = CameraRigControllerRiggingOperator()
