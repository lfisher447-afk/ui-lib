...
Blender SDK Addon Module: MeshManifoldCleaner (Index: 5)
File Reference: zerio_ui_lib/addons/mesh_manifold_cleaner.py
...
class MeshManifoldCleanerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: MeshManifoldCleaner ---")
    op = MeshManifoldCleanerRiggingOperator()
