...
Blender SDK Addon Module: NlaTracksMerger (Index: 24)
File Reference: zerio_ui_lib/addons/nla_tracks_merger.py
...
class NlaTracksMergerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: NlaTracksMerger ---")
    op = NlaTracksMergerRiggingOperator()
