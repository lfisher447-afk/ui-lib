...
Blender SDK Addon Module: AnimationCurvesSmoother (Index: 11)
File Reference: zerio_ui_lib/addons/animation_curves_smoother.py
...
class AnimationCurvesSmootherRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: AnimationCurvesSmoother ---")
    op = AnimationCurvesSmootherRiggingOperator()
