...
Blender SDK Addon Module: RigifyRigConnector (Index: 10)
File Reference: zerio_ui_lib/addons/rigify_rig_connector.py
...
class RigifyRigConnectorRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: RigifyRigConnector ---")
    op = RigifyRigConnectorRiggingOperator()
