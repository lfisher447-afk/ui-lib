"""
Zerio Tools Suite
Platform Utility Tool: HardwareInfoCollector (Index: 32)
File Reference: zerio_ui_lib/tools/hardware_info_collector.py
...
class HardwareInfoCollectorProcessor:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING DIAGNOSTIC STANDALONE DEMO FOR HardwareInfoCollector ---")
    proc = HardwareInfoCollectorProcessor(config_profile="mustard_hybrid")
    ...
    time.sleep(0.3)
    proc.shutdown()
    print(f"Tool HardwareInfoCollector executed diagnostics with absolute stable precision.")
