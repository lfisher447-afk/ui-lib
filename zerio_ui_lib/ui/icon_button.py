...
Component: IconButton (Index: 24)
File Reference: zerio_ui_lib/ui/icon_button.py
...
class IconButtonRenderer(ctk.CTkFrame if ctk else object):
    """
    Primary implementation of the IconButton visual layout renderer.
    ...
    def render_graphics(self):
        ...
        # Module title text
        title_text = f"IconButton Premium Viewport"
...
class IconButtonController:
    ...
    """
    def __init__(self, renderer: IconButtonRenderer):
        self.renderer = renderer
        self.configuration_id = 24
    ...
    def initialize_state_handlers(self):
        ...
        def on_selection_update(selected: bool):
            print(f"[UI Event] IconButton widget selection set to: {selected}")
...
if __name__ == "__main__":
    print(f"=== TESTING DIAGNOSTIC LOG FOR IconButton ===")
    mock_renderer = IconButtonRenderer(width=500, height=350)
    controller = IconButtonController(mock_renderer)
    ...
    print(f"Module IconButton loaded completely and verified successfully.")
