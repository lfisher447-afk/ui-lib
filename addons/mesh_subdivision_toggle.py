...
Blender SDK Addon Module: MeshSubdivisionToggle (Index: 16)
File Reference: zerio_ui_lib/addons/mesh_subdivision_toggle.py
...
class MeshSubdivisionToggleRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: MeshSubdivisionToggle ---")
    op = MeshSubdivisionToggleRiggingOperator()
