...
Blender SDK Addon Module: RenderQueueManager (Index: 19)
File Reference: zerio_ui_lib/addons/render_queue_manager.py
...
class RenderQueueManagerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: RenderQueueManager ---")
    op = RenderQueueManagerRiggingOperator()
