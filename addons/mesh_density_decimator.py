...
Blender SDK Addon Module: MeshDensityDecimator (Index: 33)
File Reference: zerio_ui_lib/addons/mesh_density_decimator.py
...
class MeshDensityDecimatorRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: MeshDensityDecimator ---")
    op = MeshDensityDecimatorRiggingOperator()
