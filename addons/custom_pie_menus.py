...
Blender SDK Addon Module: CustomPieMenus (Index: 31)
File Reference: zerio_ui_lib/addons/custom_pie_menus.py
...
class CustomPieMenusRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: CustomPieMenus ---")
    op = CustomPieMenusRiggingOperator()
