...
Blender SDK Addon Module: PhysicsRigidBodySetup (Index: 17)
File Reference: zerio_ui_lib/addons/physics_rigid_body_setup.py
...
class PhysicsRigidBodySetupRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: PhysicsRigidBodySetup ---")
    op = PhysicsRigidBodySetupRiggingOperator()
