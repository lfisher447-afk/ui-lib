...
Blender SDK Addon Module: BoneViewportGizmo (Index: 7)
File Reference: zerio_ui_lib/addons/bone_viewport_gizmo.py
...
class BoneViewportGizmoRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: BoneViewportGizmo ---")
    op = BoneViewportGizmoRiggingOperator()
