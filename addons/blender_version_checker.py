...
Blender SDK Addon Module: BlenderVersionChecker (Index: 32)
File Reference: zerio_ui_lib/addons/blender_version_checker.py
...
class BlenderVersionCheckerRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: BlenderVersionChecker ---")
    op = BlenderVersionCheckerRiggingOperator()
