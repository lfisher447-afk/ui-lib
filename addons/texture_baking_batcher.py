...
Blender SDK Addon Module: TextureBakingBatcher (Index: 30)
File Reference: zerio_ui_lib/addons/texture_baking_batcher.py
...
class TextureBakingBatcherRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: TextureBakingBatcher ---")
    op = TextureBakingBatcherRiggingOperator()
