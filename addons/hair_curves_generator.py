...
Blender SDK Addon Module: HairCurvesGenerator (Index: 23)
File Reference: zerio_ui_lib/addons/hair_curves_generator.py
...
class HairCurvesGeneratorRiggingOperator:
    """
...
if __name__ == "__main__":
    print(f"--- RUNNING BLENDER RIGGING OPERATOR DIAGNOSTIC: HairCurvesGenerator ---")
    op = HairCurvesGeneratorRiggingOperator()
